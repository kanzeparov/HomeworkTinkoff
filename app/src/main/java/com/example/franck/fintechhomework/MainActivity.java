...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.example.franck.fintechhomework.MESSAGEFIRST";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receiveMessage(); // explicit intent

        buttonFlag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK); //work with flag
